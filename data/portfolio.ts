...
export interface Hackathon extends PortfolioItem {
  year: number
  submission: string
  image: string
  github: string
...
export interface Product extends PortfolioItem {}
export interface Tool extends PortfolioItem {}
export interface Personal extends PortfolioItem {}
